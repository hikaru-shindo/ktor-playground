...
dependencies {
    ...
    implementation("io.ktor:ktor-server-metrics:2.3.11")
    implementation("io.ktor:ktor-server-call-id:2.3.11")
    ...
    testImplementation("dev.forkhandles:fabrikate4k:2.18.0.1")
}
