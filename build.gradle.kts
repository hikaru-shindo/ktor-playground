...
dependencies {
    ...
    implementation("io.ktor:ktor-server-metrics:2.1.2")
    implementation("io.ktor:ktor-server-call-id:2.1.2")
    ...
    testImplementation("io.ktor:ktor-client-content-negotiation:2.1.2")
