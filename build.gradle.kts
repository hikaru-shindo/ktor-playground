...
dependencies {
    ...
    implementation("io.ktor:ktor-server-metrics:3.6.0")
    implementation("io.ktor:ktor-server-call-id:3.6.0")
    implementation("io.ktor:ktor-server-forwarded-header:3.6.0")
    ...
    implementation("io.ktor:ktor-server-metrics-micrometer:3.6.0")
