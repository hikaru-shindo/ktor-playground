...
dependencies {
    ...
    implementation("io.ktor:ktor-server-metrics:3.3.2")
    ...
    implementation("io.ktor:ktor-server-metrics-micrometer:3.3.2")
    ...
    testImplementation("dev.forkhandles:fabrikate4k:2.23.0.0")
}
