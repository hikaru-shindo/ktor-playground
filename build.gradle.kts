...
dependencies {
    ...
    implementation("io.ktor:ktor-server-metrics:3.5.0")
    implementation("io.ktor:ktor-server-call-id:3.5.0")
    implementation("io.ktor:ktor-server-forwarded-header:3.5.0")
    ...
    testImplementation("dev.forkhandles:fabrikate4k:2.25.6.0")
}
