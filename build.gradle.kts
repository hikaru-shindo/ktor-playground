...
dependencies {
    ...
    implementation("io.ktor:ktor-server-metrics:3.4.3")
    implementation("io.ktor:ktor-server-call-id:3.4.3")
    implementation("io.ktor:ktor-server-forwarded-header:3.4.3")
    ...
    testImplementation("dev.forkhandles:fabrikate4k:2.25.4.0")
}
