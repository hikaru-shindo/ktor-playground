...
dependencies {
    ...
    implementation("io.ktor:ktor-server-call-id:3.2.0")
    implementation("io.ktor:ktor-server-forwarded-header:3.2.0")
    ...
    implementation("io.ktor:ktor-server-metrics-micrometer:3.2.0")
    ...
    testImplementation("dev.forkhandles:fabrikate4k:2.22.3.0")
}
